...
class WebsiteController extends Controller
{
    ...
    {
        $homeSlider = HomeSlider::where('published', 1)->get();
        ...
        // return $reviews;
        return view('website.pages.index', compact('newArriaval', 'reviews', 'sliders', 'blend_subs', 'firstSlider', 'socialLinks', 'category', 'products','homeSlider'));
    }

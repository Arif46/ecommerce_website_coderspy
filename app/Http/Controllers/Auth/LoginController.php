    ...
    */
    ...
    public function handleProviderCallback(Request $request, $provider)
    {
        ...
        if (session('link') != null) {
            ...
            return redirect('customer-dashboard')->with('success', 'You logged in sucessfully');
        }
    }
    ...
    public function logout(Request $request)
    {
        ...
        return $this->loggedOut($request) ?: redirect()->route($redirect_route)->with('success', 'Logout successfully');
    }

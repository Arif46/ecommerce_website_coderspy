<?php /* E:\xampp\htdocs\myfragmence\resources\views/flash_deals/index.blade.php */ ?>
            ...
            <tbody>
                <?php $__currentLoopData = $flash_deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $flash_deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><img class="img-md" src="<?php echo e(asset('public/'.$flash_deal->banner)); ?>" alt="banner"></td>

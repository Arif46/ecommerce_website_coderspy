<?php /* E:\xampp\htdocs\myfragmence\resources\views/frontend/partials/cart.blade.php */ ?>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dc-image">
                                        <a href="<?php echo e(route('product', $product->slug)); ?>">
                                            <img loading="lazy"  src="<?php echo e(asset('public/'.$product->thumbnail_img)); ?>" class="img-fluid" alt="">
                                        </a>
                                    </div>

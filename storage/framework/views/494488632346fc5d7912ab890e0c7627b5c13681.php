<?php /* E:\xampp\htdocs\myfragmence\resources\views/website/pages/cart.blade.php */ ?>
                        ...
                        <div class="form-default bg-white p-4">
                                        ...
                                        <?php $__currentLoopData = Session::get('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr class="cart-item">
                                                <td class="product-image">
                                                    <a href="#" class="mr-3">
                                                        <img loading="lazy"  src="<?php echo e(url('public/'.$product->thumbnail_img)); ?>">
                                                    </a>
                                                </td>
                                                ...
                                                <td class="product-remove">
                                                    <a href="#" onclick="removeFromCartView(event, <?php echo e($key); ?>)" class="text-right text-danger pl-4">
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <?php if(Auth::check()): ?>
                                        <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-primary"><?php echo e(__('Continue to Shipping')); ?></a>
                                    <?php else: ?>
                                        <button class="btn btn-primary" onclick="showCheckoutModal()"><?php echo e(__('Continue to Shipping')); ?></button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>

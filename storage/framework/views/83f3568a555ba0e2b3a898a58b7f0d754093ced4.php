<?php /* E:\xampp\htdocs\myfragmence\resources\views/dashboard.blade.php */ ?>
            ...
            <div class="col-sm-6">
                ...
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        ...
                        <br>
                        <a href="<?php echo e(route('privacy_policy')); ?>" class="btn btn-primary mar-top btn-block top-border-radius-no"><?php echo e(__('Click Here')); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">

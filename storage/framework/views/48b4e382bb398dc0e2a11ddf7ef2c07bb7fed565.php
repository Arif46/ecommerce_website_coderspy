<?php /* E:\xampp\htdocs\myfragmence\resources\views/brands/index.blade.php */ ?>
...
<div class="row">
    ...
    <div class="col-sm-3">
        <form action="<?php echo e(route('brandImport')); ?>" method="POST" name="importform" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="file" name="file" class="form-control" required>
    </div>
    <div class="col-sm-6">
        <button class="btn btn-success">Import Excel Sheet</button>
        <a class="float-right btn btn-primary" href="<?php echo e(route('brandExport')); ?>">Export Brands</a>
    </div>
    </form>
</div>
            ...
            <tbody>
                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="<?php echo e(asset('public/'.$brand->logo)); ?>" alt="Logo"></td>
                        <td><?php echo e($brand->brands_parent_company); ?></td>

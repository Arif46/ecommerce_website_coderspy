<?php /* E:\xampp\htdocs\myfragmence\resources\views/products/index.blade.php */ ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('product', $product->slug)); ?>" target="_blank" class="media-block">
                                <div class="media-left">
                                    <img loading="lazy"  class="img-md" src="<?php echo e(asset('public/'.$product->thumbnail_img)); ?>" alt="Image">
                                </div>

<?php /* E:\xampp\htdocs\myfragmence\resources\views/frontend/partials/addedToCart.blade.php */ ?>
    ...
    <div class="product-box">
        <div class="block">
            <div class="block-image">
                <img src="<?php echo e(asset('frontend/images/placeholder.jpg')); ?>" data-src="<?php echo e(asset('public/'.$product->thumbnail_img)); ?>" class="lazyload" alt="Product Image">
            </div>

<?php /* E:\xampp\htdocs\myfragmence\resources\views/layouts/app.blade.php */ ?>
<!DOCTYPE html>
...
<head>
    ...
    <?php else: ?>
        <link name="favicon" type="image/x-icon" href="<?php echo e(url('public/img/favicon.png')); ?>" rel="shortcut icon" />
    <?php endif; ?>
    <title>Myfragmence | <?php echo $__env->yieldContent('title'); ?> </title>
    <!-- Fonts -->
    <link rel="dns-prefetch" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet" type="text/css">
    <!--Bootstrap Stylesheet [ REQUIRED ]-->
    <link href="<?php echo e(asset('public/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('public/css/tagify.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('public/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.css')); ?>" rel="stylesheet">

    <!--Summernote [ OPTIONAL ]-->
    <link href="<?php echo e(asset('public/css/jodit.min.css')); ?>" rel="stylesheet">

    <!--Theme [ DEMONSTRATION ]-->
    <!-- <link href="<?php echo e(asset('public/css/themes/type-full/theme-dark-full.min.css')); ?>" rel="stylesheet"> -->
    ...
    <link href="<?php echo e(asset('public/css/myfrag.css')); ?>" rel="stylesheet">

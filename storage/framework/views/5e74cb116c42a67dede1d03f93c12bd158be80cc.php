<?php /* E:\xampp\htdocs\myfragmence\resources\views/inc/admin_nav.blade.php */ ?>
<!--NAVBAR-->

<!--===================================================-->
<header id="navbar" style="background:#8DC63F">
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="navbar-brand">
                <?php if($generalsetting->admin_logo != null): ?>
                    <?php if(File::exists(public_path($generalsetting->admin_logo))): ?>
                        <img loading="lazy"  src="<?php echo e(url('public/')); ?>/<?php echo e(($generalsetting->admin_logo)); ?>" class="brand-icon" alt="<?php echo e($generalsetting->site_name); ?>">
                        <?php else: ?>
                        <img loading="lazy"  src="<?php echo e(url('public/img/logo_shop.png')); ?>" class="brand-icon" alt="<?php echo e($generalsetting->site_name); ?>">
                    <?php endif; ?>
                <?php else: ?>

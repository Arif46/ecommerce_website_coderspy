        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('generalsettings.update',$generalsetting->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="pinterest">{{__('Pinterest')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="pinterest" name="pinterest" value="{{ $generalsetting->pinterest }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="snapchart">{{__('Snapchart')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="snapchart" name="snapchart" value="{{ $generalsetting->snapchart }}" class="form-control">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="tiktok">{{__('Tiktok')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="tiktok" name="tiktok" value="{{ $generalsetting->tiktok }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="subs_head">{{__('Subscription Head')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="subs_head" name="subs_head" value="{{ $generalsetting->subs_head }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="subs_middle">{{__('Subscription Middle')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="subs_middle" name="subs_middle" value="{{ $generalsetting->subs_middle }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="subs_bottom">{{__('Subscription Bottom')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="subs_bottom" name="subs_bottom" value="{{ $generalsetting->subs_bottom }}" class="form-control">
                        </div>
                    </div>
                </div>

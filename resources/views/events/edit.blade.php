...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="panel">
            ...
            <!--Horizontal Form-->
            <!--===================================================-->
            <form class="form-horizontal" action="{{ route('events.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="title" name="title" class="form-control" required  placeholder="{{__('Event Title')}}" required value="{{$data->title}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="url">{{__('Url')}}</label>
                        <div class="col-sm-9">
                            <input type="url" id="url" name="url" class="form-control" required  placeholder="{{__('Event Url')}}" required value="{{$data->url}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <img src="{{url('public/')}}/{{$data->img}}" alt="" height="32px" width="40px">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <img src="{{url('public/')}}/{{$data->back_img}}" alt="" height="32px" width="40px">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" id="description" name="description" class="editor" required  placeholder="{{__('Description')}}">{!! $data->description !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div id="demo-dp-range">
                                <div class="input-daterange input-group" id="datepicker">
                                    <input type="text" class="form-control" name="date" placeholder="Event Date" value="{{$data->date}}">
                                </div>
                            </div>
                        </div>
                    </div>

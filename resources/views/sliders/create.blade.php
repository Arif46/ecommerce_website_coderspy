<div class="panel">
    ...
    <form class="form-horizontal" action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-3" for="short_description">{{__('Short Description')}}</label>
                <div class="col-sm-9">
                    <input type="text" id="short_description" name="short_description" placeholder="Short Description" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3" for="serial_no">{{__('Serial Number')}}</label>
                <div class="col-sm-9">
                    <input type="number" id="serial_no" name="serial_no" placeholder="Serial Number" class="form-control" required>
                </div>
            </div>
            <div class="form-group">

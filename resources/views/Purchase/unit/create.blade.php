...
<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('Add Purchase Unit')}}</h3>
        </div>

        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('purchase.unit.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="panel-body">
                ...
                <div class="form-group start_div">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" placeholder="{{__('Unit Name')}}" id="" name="unit" class="form-control {{ $errors->has('Start Amount') ? ' is-invalid' : '' }}" required>
                        @if ($errors->has('title'))

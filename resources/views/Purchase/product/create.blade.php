...
<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('Add Purchase Product')}}</h3>
        </div>

        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('purchase.product.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group start_div">
                  ...
                  <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="{{__('Product Name')}}" id="" name="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="{{__('Product Code')}}" id="" name="code" class="form-control {{ $errors->has('code') ? ' is-invalid' : '' }}" required>
                            @if ($errors->has('code'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row">
                        <div class="col-sm-6" style ="margin-top:20px;">
                            ...
                            <input type="text" placeholder="{{__('Product Code')}}" id="" name="stock" class="form-control {{ $errors->has('stock') ? ' is-invalid' : '' }}" required>
                            @if ($errors->has('stock'))
                                <span class="invalid-feedback" role="alert">

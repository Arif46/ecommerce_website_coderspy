            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="{{ asset('public/'.$category->banner) }}" alt="{{__('banner')}}"></td>
                        <td><img loading="lazy"  class="img-xs" src="{{ asset('public/'.$category->icon) }}" alt="{{__('icon')}}"></td>

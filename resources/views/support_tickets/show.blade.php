            ...
            <div class="pad-top">
                @foreach($ticket->ticketreplies as $ticketreply)
                    <div class="media bord-top pad-top">
                        <a class="media-left" href="#"><img loading="lazy"  class="img-circle img-sm" alt="Profile Picture" src="{{ asset('public/'.$ticketreply->user->avatar_original) }}">
                        </a>
                                ...
                                @if($ticketreply->files != null && is_array(json_decode($ticketreply->files)))
                                    <div>
                                        @foreach (json_decode($ticketreply->files) as $key => $file)
                                            <div>
                                                <a href="{{ asset('public/'.$file->path) }}" download="{{ $file->name }}" class="support-file-attach bg-gray pad-all rounded">
                ...
                @endforeach
                <div class="media bord-top pad-top">
                    <a class="media-left" href="#"><img loading="lazy"  class="img-circle img-sm" alt="Profile Picture" src="{{ asset('public/'.$ticket->user->avatar_original) }}">
                    </a>
                    <div class="media-body">
                        <div class="comment-header">

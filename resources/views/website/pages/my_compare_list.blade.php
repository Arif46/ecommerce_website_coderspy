                    ...
                    <div class="col-lg-9">
                        <div class="main-content">
                            ...
                            <div class="row shop-default-wrapper shop-cards-wrapper shop-tech-wrapper mt-4">
                                @foreach ($compareLists as $key => $compare)
                                                    ...
                                                    <div class="card-image">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <a href="#" style="color:#000;" class="link link--style-3" data-toggle="tooltip" data-placement="top" title="Remove from comapre list" onclick="removeFromWishlist({{ $compare->id }})">

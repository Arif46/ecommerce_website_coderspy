    ...
    <main>
        <div class="Subscription_area text-center mb-50">
            ...
            @else
                ...
                <span><a href="">{{@$brandName->name}}</a></span>
            @endif
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#male_product').on('click',function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{url('maleProducts')}}'+'/'+'{{@$brandName->id}}',
                    success: function (data) {
                        // $('.show_content').show();
                                            ...
                                            <div class="single_tranding">
                                                <a href="{{url('product')}}/${valueOne.slug}">
                                                    ...
                                                    <div class="des">
                                                        ...
                                                        <p class="brand product_brand${valueOne.id}">${valueOne.brand.name}</p>
            ...
            $('#female_product').on('click',function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{url('femaleProducts')}}'+'/'+'{{@$brandName->id}}',
                    success: function (data) {
                        // $('.show_content').show();
                        $.each(data, function (indexOne, valueOne) {
                            $('.productView').append(` <div class="col-xl-4 col-lg-4 col-sm-12 mb-30">
            ...
            $('#unisex_product').on('click',function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{url('unisexProducts')}}'+'/'+'{{@$brandName->id}}',
                    success: function (data) {
                        // $('.show_content').show();
                        $.each(data, function (indexOne, valueOne) {
                            $('.productView').append(` <div class="col-xl-4 col-lg-4 col-sm-12 mb-30">
        ...
        $( function() {
            $( "#slider-range" ).slider({
                ...
                slide: function( event, ui ) {
                    ...
                    var bId = <?=$brandName->id;?>;
                    // alert(bId);
                    $('.productView').empty();
                    $.ajax({
                        type: 'GET',
                        url: '{{url('rengeSearch')}}'+'/'+minValue+'/'+maxValue+'/'+ bId,
                        success: function (data) {
                            $('.productView').empty();
                            $.each(data, function (indexOne, valueOne) {
                                $('.productView').append(` <div class="col-xl-4 col-lg-4 col-sm-12 mb-30">

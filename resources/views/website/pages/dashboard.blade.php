                            ...
                            <div class="col-md-6 col-12">
                                <div class="float-md-right">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active"><a href="{{ route('customerDashboard') }}">{{__('Dashboard')}}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-box bg-white mt-4">
                                    <div class="form-box-title px-3 py-2 clearfix ">
                                        ...
                                        <div class="float-right">
                                            <a href="{{ url('customer-profile') }}" class="btn btn-link btn-sm">{{__('Edit')}}</a>
                                        </div>
                                    </div>
                                    <div class="form-box-content p-3">
                                        <table>
                                            ...
                                            <tr>
                                                <td>{{__('Country')}}:</td>
                                                <td class="p-2">
                                                    @if (Auth::user()->country != NULL && !empty(Auth::user()->country))
                                                        {{-- {{ App\Country::where('code', Auth::user()->country)->firstOrFail()->name }} --}}
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>

                ...
                <div class="col-xl-8 offset-xl-2">
                    <div class="card">
                        ...
                        <div class="px-5 py-3 py-lg-5">
                            <div class="row align-items-center">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group--style-1">
                                                        @if (\App\Addon::where('unique_identifier',
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('email') }}"
                                                            placeholder="{{__('Email Or Phone')}}" name="email"
                                                            id="email">
                                                        @else
                                                        <input type="email"
                                                            class="form-control form-control-sm {{ $errors->has('email') ? ' is-invalid' : '' }}"
                                ...
                                <div class="col-12 col-lg">
                                    ...
                                    <a href="{{ route('social.login', ['provider' => 'pinterest']) }}"
                                        class="btn btn-styled btn-block btn-google btn-icon--2 btn-icon-left px-4 my-4">
                        ...
                        <div class="text-center px-35 pb-3">
                            <p class="text-md">
                                {{__('Need an account?')}} <a href="{{ route('customersRegister') }}"

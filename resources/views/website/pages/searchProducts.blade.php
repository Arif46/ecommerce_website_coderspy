                                    ...
                                    <div class="select-this">
                                        <form action="#">
                                            <div class="select-itms">
                                                <select name="sort" onchange="dropdown(this.value);" id="sort">
                                                    <option value="topRev">@lang('Top Review')</option>
                                                    <option value="mostRev">@lang('Most Review')</option>
...
@push('script')
    <script>
        function dropdown(sort){
            var value = sort;
            window.location.href = "{{url('/sortProduct',$current)}}"  + "/" + value ;
        }
    </script>

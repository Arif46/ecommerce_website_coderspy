            ...
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <div class="special-form customer-feedback-form">
                            <form method="POST" action="{{route('idea_submit')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            {{-- <div class="single-input mt-40 mb-40" >
                                ...
                                <div class="rating-numbers">
                                    <input type="text" name="feedback" value="" id="feedback" >
                                    <a onClick = "openSolution(1);" class="rating-number">1</a>
                                    <a class="rating-number active">2</a>
                                    <a class="rating-number">3</a>
                                    <a class="rating-number">4</a>
                                    <a class="rating-number">5</a>
                                    <a class="rating-number">6</a>
                                    <a class="rating-number">7</a>
                                    <a class="rating-number">8</a>
                                    <a class="rating-number">9</a>
                                    <a class="rating-number">10</a>
                                </div>
                            </div> --}}
                            <div class="single-input">
...
@push('script')
<script>
    function openSolution(feedback) {
    alert('here');

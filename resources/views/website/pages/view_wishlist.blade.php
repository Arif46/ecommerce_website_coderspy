                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <a href="{{ route('product', $wishlist->product->slug) }}" class="d-block" >
                                                                <img src="{{ url('public/')}}/{{$wishlist->product->thumbnail_img }}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-2">

                                                            <a href="#" style="color:#000;" class="link link--style-3" data-toggle="tooltip" data-placement="top" title="Remove from wishlist" onclick="removeFromWishlist({{ $wishlist->id }})">

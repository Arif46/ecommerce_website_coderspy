                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" name="photo" id="file-3" class="custom-input-file custom-input-file--4 customer_image_change" data-multiple-caption="{count} files selected" accept="image/*" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <!-- For Demo Purpose -->
                                            <input type="text" name="birth_date" placeholder="Birth Date" id="birth_date" value="{{Auth::user()->birth_date}}" class="form-control datepicker mb-3">
                                        </div>
                                        <div class="col-md-2">

        ...
        <div class="navbar-header">
            <a href="{{route('admin.dashboard')}}" class="navbar-brand">
                @if($generalsetting->admin_logo != null)
                    @if(File::exists(public_path($generalsetting->admin_logo)))
                        <img loading="lazy"  src="{{url('public/')}}/{{($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                        @else
                        <img loading="lazy"  src="{{url('public/img/logo_shop.png') }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                    @endif
                @else

...
<div class="row">
    <div class="col-sm-12">
        <a href="{{ route('raw.unit.create')}}" class="btn btn-rounded btn-info pull-right">{{__('Add raw unit')}}</a>
    </div>
...
<div class="panel">
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        <h3 class="panel-title pull-left pad-no">{{__('Manage Raw unit')}}</h3>
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a href="{{route('raw.unit.edit', encrypt(@$unit->id))}}">{{__('Edit') }}</a></li>
                                    <li><a onclick="confirm_modal('{{route('raw.unit.delete', @$unit->id)}}');">{{__('Delete')}}</a></li>
                                </ul>
                        </td>
                    </tr>
                @endforeach

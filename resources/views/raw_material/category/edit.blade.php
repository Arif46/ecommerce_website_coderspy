...
<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{__('Raw Category Update')}}</h3>
        </div>

        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ Route('raw.category.update',$category->id)}}" method="POST" enctype="multipart/form-data">
            @csrf

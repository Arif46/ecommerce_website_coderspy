        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <form action="{{ Route('raw.update',$raw->id)}}" class="form-vertical" id="insert_raw" name="insert_raw" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        @csrf
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="raw_id" type="text" id="raw_id" placeholder="Barcode/QR-code"  tabindex="1" value="{{ $raw->raw_id}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row" style="margin-bottom: 20px">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="raw_name" type="text" id="raw_name" placeholder="raw Name" required tabindex="1"  value="{{ $raw->raw_name}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control " id="serial_no" name="serial_no" placeholder="111,abc,XYz" value="{{ $raw->serial_no}}"  />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row" style="margin-bottom: 20px">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="raw_model" name="model" placeholder="Model" value="{{ $raw->model}}"  />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2" id="category_id" name="category_id" tabindex="3">
                                            ...
                                            <option value="{{$category->id }}"{{ $category->id == $raw->category_id?'selected':''}}>{{$category->name }}</option>
                                             @endforeach     
                        ...
                        <div class="row"style="margin-bottom: 20px">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control text-right" id="sell_price" name="price" type="text" required="" placeholder="0.00" tabindex="5" min="0"value="{{ $raw->price}}">
                                    </div>
                                </div> 
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2" id="unit" name="unit" tabindex="-1" aria-hidden="true">
                                           <option value="">Select one </option>
                                            ...
                                            <option value="{{$unit->id }}" {{ $unit->id == $raw->unit?'selected':''}}>{{$unit->name }}</option>
                                             @endforeach  
                        ...
                        <div class="row"style="margin-bottom: 20px">
                            ...
                            <div class="col-sm-6"style="margin-bottom: 20px">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                      <input type="text" name="vat" class="form-control" value="{{ $raw->vat}}" >
                            ...
                            <div class="col-sm-6">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                      <input type="text" name="tax" class="form-control" value="{{ $raw->tax}}">
                                    </div>
                                    <div class="col-sm-1"> <i class="text-success">%</i></div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive raw-supplier" id="product_item">
                            ...
                            <table class="table table-bordered table-hover"  id="raw_table">
                                ...
                                <tbody>
                                    @foreach(App\RawMaterialsDetails::where('raw_id', $raw->id)->get() as $count)
                                    <tr class="">
                                        ...
                                        <td width="300">
                                            <select name="supplier_id[]" class="form-control select2"  required="" >
                                                ...
                                                <option value="{{$supply->id }}" {{ $count->supplier_id == $supply->id?'selected':''}}>{{$supply->supplier_name }}</option>
                                                 @endforeach  
                                        ...
                                        <td class="">
                                            ...
                                            <input type="text" tabindex="6" class="form-control text-right" name="supplier_price[]" placeholder="0.00"  required  min="0"  value = " @foreach($suppliers as $supply){{ $count->supplier_id == $supply->id? $count->supplier_price:''}}@endforeach">
                        ...
                        <div class="row"style="margin-bottom: 20px">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="2" placeholder="raw Details" tabindex="2">{{ $raw->description}}</textarea>
                            </div>
                        </div><br>
                        <div class="form-group row">
                            <div class="col-sm-6">

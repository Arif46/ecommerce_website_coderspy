...
@section('meta')
    ...
    <meta itemprop="image" content="{{ asset('public/'.$detailedProduct->meta_img) }}">
    ...
    <meta name="twitter:image" content="{{ asset('public/'.$detailedProduct->meta_img) }}">
    ...
    <meta property="og:image" content="{{ asset('public/'.$detailedProduct->meta_img) }}" />
                                ...
                                <div class="product-gal-thumb">
                                    <div class="xzoom-thumbs">
                                        @foreach (json_decode($detailedProduct->photos) as $key => $photo)
                                            <a href="{{ asset('public/'.$photo) }}">
                                                <img src="{{ asset('frontend/images/placeholder.jpg') }}" class="xzoom-gallery lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" width="80" data-src="{{ asset('public/'.$photo) }}"  @if($key == 0) xpreview="{{ asset('public/'.$photo) }}" @endif>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <div class="product-description-wrapper">
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank"> @if ($refund_sticker != null && $refund_sticker->value != null && $detailedProduct->refundable == 1) <img src="{{ asset('public/'.$refund_sticker->value) }}" height="36"> @else <img src="{{ asset('frontend/images/refund-sticker.jpg') }}" height="36"> @endif</a>
                                ...
                                <div class="clearfix">
                                    <div class="product-image float-left">
                                        <a href="{{ route('product', $top_product->slug) }}">
                                            <img class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('public/'.$top_product->thumbnail_img) }}" alt="{{ __($top_product->name) }}">
                                        </a>
                                    </div>
                            ...
                            <div class="tab-content pt-0">
                                ...
                                <div class="tab-pane" id="tab_default_3">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{ asset('public/'.$detailedProduct->pdf) }}">{{ __('Download') }}</a>
                                            </div>
                                        </div>
                                        <span class="space-md-md"></span>
                                    </div>
                                        ...
                                        @foreach ($detailedProduct->reviews as $key => $review)
                                            <div class="block block-comment">
                                                <div class="block-image">
                                                    <img src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('public/'.$review->user->avatar_original) }}" class="rounded-circle lazyload">
                                                </div>
                                        ...
                                        <div class="col-5">
                                            <div class="position-relative overflow-hidden h-100">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center">
                                                    <img class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('public/'.$related_product->thumbnail_img) }}" alt="{{ __($related_product->name) }}">
                                                </a>
                                            </div>
                                        </div>

                    ...
                    <ul class="side-seller-menu">
                        @foreach (\App\Category::all() as $key => $category)
                            ...
                            <a href="{{ route('products.category', $category->slug) }}" class="text-truncate">
                                <img class="cat-image lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('public/'.$category->icon) }}" width="13" alt="{{ __($category->name) }}">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="navbar-brand w-100" href="{{ route('home') }}">
                                ...
                                @if($generalsetting->logo != null)
                                    <img src="{{ asset('public/'.$generalsetting->logo) }}" alt="{{ env('APP_NAME') }}">
                                @else
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="dc-image">
                                                                                <a href="{{ route('product', $product->slug) }}">
                                                                                    <img src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset('public/'.$product->thumbnail_img) }}" class="img-fluid lazyload" alt="{{ __($product->name) }}">
                                                                                </a>
                                                                            </div>

                                                ...
                                                <div class="d-flex flex-row-reverse">
                                                    <div class="pl-3">
                                                        <div class="block-image d-block size-40" data-toggle="tooltip" data-title="{{ $ticketreply->user->name }}">
                                                            <img loading="lazy"  src="{{ asset('public/'.$ticketreply->user->avatar_original) }}" class="rounded-circle">
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="mt-3 clearfix">
                                                                    @foreach (json_decode($ticketreply->files) as $key => $file)
                                                                        <div class="float-right bg-white p-2 rounded ml-2">
                                                                            <a href="{{ asset('public/'.$file->path) }}" download="{{ $file->name }}" class="file-preview d-block text-black-50" style="width:100px">
                                        ...
                                        @else
                                            <div class="block block-comment mb-3 border-0">
                                                <div class="d-flex">
                                                    <div class="pr-3">
                                                        <div class="block-image d-block size-40" data-toggle="tooltip" data-title="{{ $ticketreply->user->name }}">
                                                            <img loading="lazy"  src="{{ asset('public/'.$ticketreply->user->avatar_original) }}" class="rounded-circle" data-toggle="tooltip" data-title="fsdfsf">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="d-flex flex-row-reverse">
                                            <div class="pl-3">
                                                <div class="block-image d-block size-40">
                                                    <img loading="lazy"  src="{{ asset('public/'.$ticket->user->avatar_original) }}" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ml-5 pl-5">
                                                <div class="p-3 bg-gray rounded">

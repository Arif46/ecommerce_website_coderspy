                            ...
                            <div class="px-5 py-3 py-lg-5">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 col-lg">
                                        ...
                                        @endif
                                            @if (\App\BusinessSetting::where('type', 'linkedin_login')->first()->value == 1)
                                                <a href="{{ route('social.login', ['provider' => 'linkedin']) }}" class="btn btn-styled btn-block btn-linkedin btn-icon--2 btn-icon-left px-4 my-4">
                                                    <i class="icon fa fa-linkedin"></i> {{__('Login with Linkedin')}}
                                                </a>
                                            @endif
                                            @if (\App\BusinessSetting::where('type', 'instagram_login')->first()->value == 1)
                                                <a href="{{ route('social.login', ['provider' => 'instagram']) }}" class="btn btn-styled btn-block btn-instagram btn-icon--2 btn-icon-left px-4 my-4">
                                                    <i class="icon fa fa-instagram"></i> {{__('Login with Instagram')}}
                                                </a>
                                            @endif

                                            @if (\App\BusinessSetting::where('type', 'pinterest_login')->first()->value == 1)
                                                <a href="{{ route('social.login', ['provider' => 'pinterest']) }}" class="btn btn-styled btn-block btn-google btn-icon--2 btn-icon-left px-4 my-4">
                                                    <i class="icon fa fa-pinterest"></i> {{__('Login with Pinterest')}}
                                                </a>
                                            @endif
                                    </div>
                                </div>
